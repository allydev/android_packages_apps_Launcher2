...
final class Utilities {
	...
	/* On medium density size of the texture comes 64 but thats 
	 * insufficient for text to accoumodate, increase it to 128.
	 */
	if (density == 1.0f)
	    sIconTextureWidth = sIconTextureHeight = 128;
